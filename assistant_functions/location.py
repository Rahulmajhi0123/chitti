...
class Location:
    ...
    def main(self, text, intent):
        samples = {
            ...
            "locate me" : {'function' : self.say_location, 'type' : 'location'},
            "which city is this" : {'function' : self.say_location, 'type' : 'city'},
            "which state is this" : {'function' : self.say_location, 'type' : 'state'},
